...
describe('ReactPhotoEditor Component', () => {
	...
	it('should render rotate div correctly', () => {
		render(
			<ReactPhotoEditor file={fileData} onSaveImage={onSaveImage} open={true} allowRotate={true} />
		);
	...
	it('should render flip buttons', () => {
		render(
			<ReactPhotoEditor file={fileData} onSaveImage={onSaveImage} open={true} allowFlip={true} />
		);
	...
	it('should render zoom buttons', () => {
		render(
			<ReactPhotoEditor file={fileData} onSaveImage={onSaveImage} open={true} allowZoom={true} />
		);
	...
	it('should not render component if open == false', () => {
		render(<ReactPhotoEditor file={fileData} onSaveImage={onSaveImage} open={false} />);
